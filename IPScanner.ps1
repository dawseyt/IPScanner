...
param(
	[switch]$HideConsole,
	[switch]$EnableExternalLookup,
	[switch]$EnableVendorLookup
)

$global:EnableOnlineExternalLookup = $EnableExternalLookup.IsPresent
$global:EnableOnlineVendorLookup = $EnableVendorLookup.IsPresent
...
"@ -Name "Win32" -Namespace "Win32Functions"
	...
	if ($hwnd -ne [IntPtr]::Zero) {
		[void][Win32Functions.Win32]::ShowWindow($hwnd, $(if ($Visible) { 5 } else { 0 }))
	}
}
...
function Get-HostInfo {
	...
	$getHostInfoScriptBlock = {
		...
		# Optional internet lookup for external IPv4
		$externalIP = 'Disabled (enable online lookup)'
		if ($enableExternalIpLookup) {
	...
	$getHostInfoThread.AddArgument($enableExternalIpLookup)
...
function processVendors {
	if (-not $global:EnableOnlineVendorLookup) {
		foreach ($item in $listView.Items) {
			if ($item.Vendor -eq 'Identifying...') {
				$item.Vendor = 'Lookup Disabled'
			}
		}
		$listView.Items.Refresh()
		return
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
		...
		Height="500" Width="920" Background="Transparent" AllowsTransparency="True" WindowStyle="None">
	<Window.Resources>
	...
	<Border Background="#17181D" CornerRadius="10" SnapsToDevicePixels="True">
		<Grid>
			<Grid.RowDefinitions>
				<RowDefinition Height="30"/>
				<RowDefinition Height="*"/>
			</Grid.RowDefinitions>
			<Border Background="#252833" Grid.Row="0" CornerRadius="10,10,0,0">
				<Grid>
					<Grid.ColumnDefinitions>
						<ColumnDefinition Width="Auto"/>
						<ColumnDefinition Width="Auto"/>
					...
					<TextBlock Name="TitleBar" Foreground="#F5F7FA" FontWeight="Bold" VerticalAlignment="Center" HorizontalAlignment="Left" Margin="0,0,5,0" Grid.Column="1"/>
					<Grid Grid.Column="2">
						<Grid.ColumnDefinitions>
							<ColumnDefinition Width="Auto"/>
							<ColumnDefinition Width="Auto"/>
						</Grid.ColumnDefinitions>
						<TextBlock Name="externalIPt" Foreground="#D7D9E0" FontWeight="Bold" VerticalAlignment="Center" Margin="0,0,5,0"/>
						<TextBlock Name="domainName" Foreground="#D7D9E0" FontWeight="Bold" VerticalAlignment="Center" Margin="0,0,5,0" Grid.Column="1"/>
					</Grid>
					<StackPanel Orientation="Horizontal" HorizontalAlignment="Right" Grid.Column="3">
						...
						<Button Name="btnMinimize" Width="40" Height="30" Background="Transparent" Foreground="#E6EAF3" BorderThickness="0" Template="{StaticResource NoMouseOverButtonTemplate}">
							<Path Width="15" Height="2" Stretch="Fill" Stroke="#E6EAF3" StrokeThickness="1" Data="M0,0 L15,0" HorizontalAlignment="Center" VerticalAlignment="Center"/>
						</Button>
						<Button Name="btnClose" Content="✕" Width="40" Height="30" Background="Transparent" Foreground="#E6EAF3" FontWeight="Bold" BorderThickness="0" Template="{StaticResource CloseButtonTemplate}"/>
					</StackPanel>
				</Grid>
			</Border>
			<Grid Grid.Row="1">
				<Grid Name="IPScannerContentGrid" Margin="0,0,18,0">
					<Grid Name="ScanContainer" Grid.Column="0" VerticalAlignment="Top" HorizontalAlignment="Center" Width="777" MinHeight="25" Margin="53,11,0,0">
						<Button Name="Scan" Width="777" Height="30" Background="#2E3445" Foreground="#F0F3FA" FontWeight="Bold" Template="{StaticResource NoMouseOverButtonTemplate}">
							<Button.ContextMenu>
							...
							<Button.Content>
								<StackPanel Orientation="Horizontal" HorizontalAlignment="Center" VerticalAlignment="Center">
									<TextBlock Name="ScanButtonText" Text="Scan" Foreground="#F0F3FA" FontWeight="Bold" />
						...
						<ProgressBar Name="Progress" Foreground="#3FA7FF" Background="#2E3445" Value="0" Maximum="100" Width="777" Height="30" Visibility="Collapsed"/>
						<TextBlock Name="BarText" Foreground="#F0F3FA" FontWeight="Bold" HorizontalAlignment="Center" VerticalAlignment="Center"/>
						<StackPanel Orientation="Horizontal" HorizontalAlignment="Right" Margin="0,34,4,0" VerticalAlignment="Top">
							<CheckBox Name="ExternalLookupToggle" Content="External IP (online)" Margin="0,0,16,0" Foreground="#D0D0D0" IsChecked="False"/>
...
$Main.Add_ContentRendered({
	...
	$ExternalLookupToggle.IsChecked = $global:EnableOnlineExternalLookup
	$VendorLookupToggle.IsChecked = $global:EnableOnlineVendorLookup
...
$Scan.Add_MouseEnter({
	$Scan.Background = '#3B4359'
})

$Scan.Add_MouseLeave({
	$Scan.Background = '#2E3445'
})
...
$Scan.Add_Click({
	...
	if ($global:CtrlIsDown) {
		...
		Update-uiMain
		$global:EnableOnlineExternalLookup = [bool]$ExternalLookupToggle.IsChecked
		$global:EnableOnlineVendorLookup = [bool]$VendorLookupToggle.IsChecked
		Get-HostInfo -gateway $global:gateway -gatewayPrefix $global:gatewayPrefix -originalGatewayPrefix $originalGatewayPrefix -enableExternalIpLookup $global:EnableOnlineExternalLookup
		...
		if (-not $global:EnableOnlineExternalLookup) {
			$externalIPt.Text = "`- `[ External IP: Disabled `]"
		}
